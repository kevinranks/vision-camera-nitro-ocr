...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroocr::BoundingBox> final {
    static inline margelo::nitro::nitroocr::BoundingBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroocr::BoundingBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroocr::BoundingBox& arg) {
